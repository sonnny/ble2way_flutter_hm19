...
Padding(padding: EdgeInsets.all(12.0),
child: Text('''
to boot to your program, ground pin 19
before pluggin in the pico wait for
about 5 seconds

using thonny to boot to interactive mode
do not ground pin 19 for about 5 seconds

content of main.py

import time
from machine import Pin
start = Pin(19, Pin.IN, Pin.PULL_UP)
time.sleep(3)
print(start)
if not start():
    import uart_ble2way
...
Padding(padding: EdgeInsets.all(12.0),
child: Text('''
another micropython code demo to
show two way ble
this is saved as main.py
you have 5 seconds in thonny to stop program
to return to repl prompt otherwise
it will continue with the program

from machine import Pin, UART
import neopixel
import time

time.sleep(5) # you have 5 seconds to interrupt

u = UART(1, 115200)
n = neopixel.NeoPixel(Pin(16),2)
buf = bytearray(3)
index = 0
...
//final devId = 'A4:DA:32:55:06:1E'; // HM-19 short module
final devId = '9C:1D:58:0F:3B:D8'; // SH-HC-08 long module
...
////////// flutter widgets/my_appbar.dart
Padding(padding: EdgeInsets.all(12.0),
